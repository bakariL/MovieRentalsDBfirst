...
using MovvvieApp.Models;

namespace MovvvieApp.Controllers
{
    public class RentalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RentalID,CustomerID,MovieID,DateReadnted")] Rental rental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RentalID,CustomerID,MovieID,DateReadnted")] Rental rental)
        {
            if (ModelState.IsValid)
            {
